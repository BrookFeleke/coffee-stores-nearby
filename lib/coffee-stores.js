...
export const fetchCoffeeStores = async (latLong= '8.949697666499166%2C38.72713045818331',radius='90000') => {
  ...
  return radius === '90000'? final.map((store, index) => {
    return {
      ...store,
      imgUrl: photos[index],
    };
  }):final.map((store, index) => {
    return {
      ...store,
      imgUrl: photos[index],
    };
